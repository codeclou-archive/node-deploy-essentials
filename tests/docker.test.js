...
test('docker _extractDockerIdFromDockerPsOutputByPort', t => {
...
test('docker _extractPortFromDockerPortsEntry', t => {
    const port = docker._extractPortFromDockerPortsEntry('0.0.0.0:4222->4443/tcp');
    t.is(port, '4222');
});

test('docker _extractDockerIdFromDockerPsOutputByName', t => {
